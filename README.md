...
### Anthropic
Requests are automatically translated from OpenAI format to Anthropic's Messages API format, and responses are translated back. Streaming is fully supported.
